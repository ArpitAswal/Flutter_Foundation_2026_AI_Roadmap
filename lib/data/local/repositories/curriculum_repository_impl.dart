...
///
/// Loads curriculum structure from the skeleton index JSON and lazily loads
/// per-day content from individual asset files only when requested.
...
class CurriculumRepositoryImpl implements CurriculumRepository {
  ...
  Future<LessonContent> getDayContent(String contentPath) {
    return _dataSource.getDayContent(contentPath);
  }
}
